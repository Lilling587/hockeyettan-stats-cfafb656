...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hockeyettan stats" },
      { name: "description", content: "Matchstatistik för HockeyEttan Södra-sändningar. Välj två lag och få form, inbördes möten, poängliga och special teams på sekunder." },
      { name: "theme-color", content: "#0F172A" },
      { property: "og:title", content: "Hockeyettan stats" },
      { property: "og:description", content: "Matchstatistik för HockeyEttan Södra-sändningar. Välj två lag och få form, inbördes möten, poängliga och special teams på sekunder." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Hockeyettan stats" },
      { name: "twitter:description", content: "Matchstatistik för HockeyEttan Södra-sändningar. Välj två lag och få form, inbördes möten, poängliga och special teams på sekunder." },
