...
const TeamBriefing = z.object({
  ...
  faceoffs: z.object({
    ...
    teamFoWins: z.number().int().nullable().default(null).describe("Total faceoff wins this season"),
    teamFoTotal: z.number().int().nullable().default(null).describe("Total faceoffs taken this season"),
 ...
 shotsForPerGame: z.number().nullable().default(null).describe("Season shots on goal per game (SOG/GP from scoring efficiency page)"),
  ...
  otWins: z.number().int().nullable().default(null).describe("Overtime wins (OTW, excludes shootout)"),
  otLosses: z.number().int().nullable().default(null).describe("Overtime losses (OTL, excludes shootout)"),
  gwsw: z.number().int().nullable().default(null).describe("Shootout wins (GWSW)"),
  gwsl: z.number().int().nullable().default(null).describe("Shootout losses (GWSL)"),
});
